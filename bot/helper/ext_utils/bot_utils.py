...
def get_readable_message():
    ...
    msg += f"<b>UPTM:</b> {get_readable_time(time() - botStartTime)} <b>| FREE:</b> {get_readable_file_size(disk_usage(config_dict['DOWNLOAD_DIR']).free)}"
